/*Escribir un programa para calcule el áreade un triángulo, el perímetrode un triangulo
*/
#include <iostream>
...
float area_funcion(int base, int altura){//para ello necesitaremos el area y la altura
float operacion =0;//creamos la variable operacion

operacion=base*altura/2;//en la variable operacion se pondra la multipliacion de base por altura/2
...
operacion=(base+altura+altura);//en la variable operacion pondremos la suma de base + altura + altura
